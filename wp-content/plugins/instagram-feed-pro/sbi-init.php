...
function display_sb_instagram_feed($atts, $content = null) {
    ...
    //Load More button
    if( $sb_instagram_show_btn ) $sb_instagram_content .= '<a class="sbi_load_btn" href="javascript:void(0);" '.$sb_instagram_button_styles.'><span class="sbi_btn_text">'._e($atts['buttontext']).'</span><span class="fa fa-spinner fa-pulse"></span></a>';
