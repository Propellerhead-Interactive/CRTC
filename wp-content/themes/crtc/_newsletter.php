...
<div class="row">
  <div class="col-sm-4 col-sm-offset-4">
		<form style="margin-bottom: 40px" target="_blank" method='get' accept-charset='UTF-8' name='oi_form' action="<?php if(ICL_LANGUAGE_CODE=='en'){echo "https://fb-subscribe-form.com/oi/1132/42034d257db5ed20ecaf7c9a6994b178";
      }else{
